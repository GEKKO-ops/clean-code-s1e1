...
var editTask=function(){
    ...
    var label=listItem.querySelector(".label_text");
    ...
    if(containsClass){
        ...
        if (completedTasksHolder.querySelector("todo-list__item_edit-mode")) {
        listItem.classList.remove("done-list__item");
        }
     } else {
        editInput.value=label.innerText;
        editBtn.innerText="Save";
        if (completedTasksHolder.querySelector("todo-list__item_edit-mode")) {
        listItem.classList.add("done-list__item");
        }
    }
...
var taskCompleted=function(){
    ...
    if (completedTasksHolder.contains(this)){
        if (listItem.querySelector(".btn_edit").innerHTML === "Save"){
          listItem.classList.toggle("done-list__item");
        }
      }
      if (!listItem.classList.contains('todo-list__item_edit-mode')){
        listItem.className = "done-list__item list-item";
      }
...
//Mark task as incomplete.
    ...
    if (listItem.classList.contains('todo-list__item_edit-mode')){
        listItem.classList.remove("done-list__item");
        listItem.className = "todo-list__item todo-list__item_edit-mode list-item";
      }
    if (listItem.classList.contains('done-list__item')){
        listItem.classList.remove("done-list__item");
